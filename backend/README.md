...
## Project Structure
    ...
    ├── testapiautoteammemb_54729  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_54729`
...
2. Clone this repo and `cd testapiautoteammemb_54729`
